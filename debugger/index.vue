<template>
  <el-form :inline="true" :model="form" name="queryForm">
    <el-form-item label="name">
      <el-input v-model="form.name" placeholder="Please input [object Object]"></el-input>
    </el-form-item>
    <el-form-item label="phone">
      <el-input v-model="form.phone" placeholder="Please input [object Object]"></el-input>
    </el-form-item>
    <el-form-item label="email">
      <el-input v-model="form.email" placeholder="Please input [object Object]"></el-input>
    </el-form-item>
    <el-form-item>
