        ...
        <template #default="scope">
          ...
          <div v-show="item.editable || scope.row.editable">
            ...
            <template v-else-if="item.type === 'datepicker'">
              <el-date-picker v-model="scope.row[item.prop]" type="date" placeholder="Pick a day" size="default" format="YYYY/MM/DD" value-format="YYYY-MM-DD">
