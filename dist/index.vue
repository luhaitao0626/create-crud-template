<template>
  <el-form :inline="true" :model="form" name="queryForm">
    <el-form-item label="username">
      <el-input v-model="form.username" placeholder="Please input 用户名"></el-input>
    </el-form-item>
    <el-form-item label="phone">
      <el-input v-model="form.phone" placeholder="Please input 手机号"></el-input>
    </el-form-item>
    <el-form-item label="email">
      <el-input v-model="form.email" placeholder="Please input 电子邮箱"></el-input>
    </el-form-item>
    <el-form-item>
  ...
  <el-pagination v-model:current-page="pagination.pageNum" v-model:page-size="pagination.pageSize" :page-sizes="[3, 5, 10, 20]" :small="false" :disabled="false" :background="true" layout="total, sizes, prev, pager, next, jumper" :total="total" @size-change="handleSizeChange" @current-change="handleCurrentChange"></el-pagination>
</template>
