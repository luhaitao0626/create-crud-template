...
class Compiler {
  ...
  async checkOutputEnv(){
    ...
    if (isDirectory(outPath)) { // if there has a directory that has the same name with this.entity
      ...
      //     "refuse"
      //   ],
      //   message: `[Critical Warning]: There already has a directory named ${this.entity} and it is not empty. 
      //   Do you want to remove the content and emit files in to the folder`,
      // });
